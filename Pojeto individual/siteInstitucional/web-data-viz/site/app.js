...
var cadastroComentarioRouter = require("./src/routes/cadastroComentarios");
var graficosRouter = require("./src/routes/grafico");
var qtdUsuarios = require("./src/routes/graficoUsuario");
...
app.use("/cadastroComentarios", cadastroComentarioRouter)
app.use("/graficoUsuario", qtdUsuarios);
